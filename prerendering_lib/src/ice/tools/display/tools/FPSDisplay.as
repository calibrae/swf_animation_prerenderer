...
import flash.utils.getTimer;
    ...
    public function FPSDisplay() {
		...
		_poolSize.y = 42;
		this.addChild(_poolSize);

        _fpstext.width = _memText.width = _animationCountText.width = _poolSize.width = 200;
        _fpstext.defaultTextFormat = _memText.defaultTextFormat = _animationCountText.defaultTextFormat = _poolSize.defaultTextFormat = _textFormat;
    ...
    private function onEnterFrame(event:Event):void {
		...
		_poolSize.text = "POOL SIZE: " + PrerenderedMovieClip.ITEMS_CREATION_COUNT + " items (" + PrerenderedMovieClip.ITEMS_AVAILABLE_COUNT + ")";
    }
	...
	private var _poolSize : TextField;
